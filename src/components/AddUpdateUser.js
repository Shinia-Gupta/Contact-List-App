      ...
      <Modal>
        <Formik
          ...
          onSubmit={(values) => {
            ...
            {
              isUpdate ? updateContact(contactObj) : addContact(contactObj);
            }
          }}
        >
          <Form className="flex flex-col gap-4 ">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="street" className="font-bold uppercase">
                Street
              </label>
              <Field
                name="street"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="suite" className="font-bold uppercase">
                Suite
              </label>
              <Field
                name="suite"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="zipcode" className="font-bold uppercase">
                ZipCode
              </label>
              <Field
                name="zipcode"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="company" className="font-bold uppercase">
                Company
              </label>
              <Field
                name="company"
            ...
            <button className="self-end border bg-orange px-3 text-xl font-bold rounded">
              {isUpdate ? "Update" : "Add"}
            </button>
          </Form>
        </Formik>
