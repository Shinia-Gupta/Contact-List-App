...
function ContactInfo() {
  const { showContactInfo, contactInfo } = useSelector(contactSelector);  // Get state from Redux store
      ...
      <div className="bg-black bg-opacity-60 md:w-full sm:min-h-[200px] rounded-br-lg">
        <div className="flex justify-between items-center m-2 bg-white bg-opacity-35 p-2 rounded-lg">
          ...
          <button
            ...
            onClick={() => dispatch(contactActions.setShowAddForm())}  // Dispatch action to show add form
          >
            Add New Contact
          </button>
        </div>
        {showContactInfo ? (  // Conditionally render contact info if available
          <div>
            <IoCloseCircle
              ...
              }  // Dispatch action to hide contact info
            />
            ...
            <div className="bg-white bg-opacity-15 p-2 rounded-lg">
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200">
                  <span className="text-orange-400">Name:</span> {contactInfo.name}
                </h2>
              </div>
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200">
                  <span className="text-orange-400">Email:</span> {contactInfo.email}
                </h2>
              </div>
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200">
              ...
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200 indent-8">
                  <span className="text-orange-400">City:</span> {contactInfo.address.city}
                </h2>
              </div>
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200 indent-8">
                  <span className="text-orange-400">Street:</span> {contactInfo.address.street}
                </h2>
              </div>
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200 indent-8">
                  <span className="text-orange-400">Suite:</span> {contactInfo.address.suite}
                </h2>
              </div>
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200 indent-8">
                  <span className="text-orange-400">ZipCode:</span> {contactInfo.address.zipcode}
                </h2>
              </div>
              <div className="bg-green-800 bg-opacity-30 rounded p-2 mb-1">
                <h2 className="font-bold text-green-200">
                  <span className="text-orange-400">Company:</span> {contactInfo.company.name}
                </h2>
              </div>
            </div>
          </div>
          ...
          </h1>  // Placeholder text when no contact is selected
        )}
      </div>
    </>
  );
